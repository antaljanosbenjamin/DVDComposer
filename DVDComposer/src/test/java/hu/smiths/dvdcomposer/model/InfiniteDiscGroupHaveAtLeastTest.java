...
public class InfiniteDiscGroupHaveAtLeastTest {
	...
	public InfiniteDiscGroupHaveAtLeastTest(String groupName, Long groupSizeInBytes,
	...
	public void hasAtLeastTests() {
		...
		for (int i = 0; i < testValuesForCount.size(); i++) {
			assertEquals(Boolean.TRUE, group.haveAtLeast(testValuesForCount.get(i)));
		}
