...
public class ISOWriter {
	...
	public void writeDummyData() {
		...
		try {
			...
			ISO9660File file1;
			file1 = new ISO9660File(getClass().getResource("/a.txt").getFile());

			root.addFile(file1);
			ISO9660File file2 = new ISO9660File(getClass().getResource("/b.txt").getFile());
			root.addFile(file2);
			ISO9660File file3 = new ISO9660File(getClass().getResource("/c.txt").getFile());
			root.addFile(file3);
